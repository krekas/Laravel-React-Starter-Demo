 ...
 * @see app/Http/Controllers/TaskController.php:37
 * @route /tasks
 */
 ...
 * @route /tasks/{task}
 */
export const show = (args: { task: string | number } | [task: string | number] | string | number, options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'get',
} => ({
 ...
 * @route /tasks/{task}
 */
show.url = (args: { task: string | number } | [task: string | number] | string | number, options?: { query?: QueryParams, mergeQuery?: QueryParams }) => {
 ...
 * @route /tasks/{task}
 */
show.get = (args: { task: string | number } | [task: string | number] | string | number, options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'get',
} => ({
    url: show.url(args, options),
 ...
 * @route /tasks/{task}
 */
show.head = (args: { task: string | number } | [task: string | number] | string | number, options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'head',
} => ({
    url: show.url(args, options),
 ...
 * @see app/Http/Controllers/TaskController.php:53
...
const tasks = { index, create, store, show, edit, update, destroy }
